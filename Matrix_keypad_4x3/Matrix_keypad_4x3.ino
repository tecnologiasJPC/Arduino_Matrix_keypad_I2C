 ...
 *  circuit https://drive.google.com/file/d/1vDxygQZMNWSI6V1Mri5pwTb9inpunjVz/view?usp=sharing
...
const byte COLS = 3;              // 3 columns in matrix keypad
...
byte colPins[COLS] = {4, 5, 6};    // column pins connected to I2C module
